# Nginx (WordPress) service for Wodby

Use Nginx (WordPress) as a reusable component in applications managed by Wodby.
This repository contains the service manifests and referenced files used by the
public Nginx (WordPress) service in the Wodby catalog.

- [Nginx (WordPress) service in the Wodby catalog](https://wodby.com/services/wordpress-nginx)
...
4. Reference `wordpress-nginx` from your stack manifest.
